...
export default async function Login(props: { searchParams: Promise<Message> }) {
  ...
  return (
    <form className="flex-1 flex flex-col min-w-64">
      ...
      <div className="mt-4">
        <button
          className="w-full flex items-center justify-center gap-2 bg-white text-gray-800 border border-gray-300 rounded-md px-4 py-2 text-sm font-medium hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
