...
import { BaseArticleGeneratedContent } from ".";
...
export async function generateHowToCreateGalleryWebsiteArticleContent(
  title: string,
  platform: Platform,
  galleryType: GalleryType
): Promise<BaseArticleGeneratedContent> {
...
The article will be about how to create a specific type of gallery website on a particular platform.
The main content of the article should cover:
1. How to create a gallery website on the platform
2. How to create a successful gallery website of the specific type 
3. Tips and tricks for the platform
